...
const GoogleSearch: React.FC<GoogleSearchProps> = ({ showGoogleSearch, onBack, onSubmit }) => {
        ...
        <View style={styles.container}>
          <View style={styles.subContainer}>
            <View style={styles.searchBar}>
              ...
              <Text style={styles.textSearch}>{translateText('search_address')}</Text>
            </View>
