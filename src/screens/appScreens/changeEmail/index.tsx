...
import {BackHandler, Image, Keyboard, Text, View} from 'react-native';
...
const ChangeEmail = (props: any) => {
  ...
  const methodForgotPassword = () => {
    ...
    if (validForm.status) {
      const request: any = {...forgotPasswordForm, type: 'EMAIL_VERIFICATION'};
      ...
      <View
        ...
        <KeyboardScroll>
          ...
          <Text style={styles.welcome_text}>
            {translateText('change_email')}
          </Text>
          <Text style={styles.enter_details_text}>
            {translateText('please_enter_new_email_address')}
          </Text>
          <AppInput
