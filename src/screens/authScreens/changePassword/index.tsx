...
const ChangePassword = (props: any) => {
  ...
  const methodChangePassword = () => {
    ...
    if (validForm.status) {
      ...
      dispatch(changePasswordAction(request)).then((res: boolean) => {
    ...
    <Background backgroundStyle={styles.container}>
      <KeyboardScroll>
        ...
        <AppInput
          ...
          placeholder={translateText('enter_your_current_password')}
          label={translateText('current_password')}
        ...
        <AppInput
          ...
          inputLeftImage={imagePath.lock_icon}
          label={translateText('new_password')}
        ...
        <AppInput
          placeholder={translateText('enter_your_confirm_password')}
          inputLeftImage={imagePath.lock_icon}
          label={translateText('confirm_new_password')}
