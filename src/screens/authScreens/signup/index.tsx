...
import { checkUserAction } from '../../../redux/actions/userSessionAction';
  ...
  const methodSignup = () => {
    ...
    if (validForm.status) {
      ...
      dispatch(checkUserAction(request)).then((res: any) => {
        console.log('res>>>>>>>verification data', res);
      ...
      <Background>
        ...
        /> */}
          ...
          <AppInput
            ...
            maxLength={maxLengthPassword}
            placeholder={translateText('enter_confirm_passord')}
